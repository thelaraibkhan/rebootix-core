...
# Output:
# - dist/Rebootix.app
# - dist/Rebootix-<version>.zip
# - dist/Rebootix-<version>.dmg
...
APP="$ROOT_DIR/dist/Rebootix.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Rebootix-$VERSION.zip"
DMG="$ROOT_DIR/dist/Rebootix-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Rebootix-$VERSION.notary.zip"
