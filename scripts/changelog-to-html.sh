...
if [[ -z "$version_content" ]]; then
  echo "<h2>Rebootix $VERSION</h2>"
  echo "<p>Latest Rebootix update.</p>"
  echo "<p><a href=\"https://github.com/rebootix/rebootix/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
