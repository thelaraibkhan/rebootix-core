...
struct ConnectOptions {
    ...
    var clientId: String = "rebootix-macos"
...
func runConnect(_ args: [String]) async {
    ...
    if opts.help {
        ...
        Options:
          ...
          --json             Emit JSON
          --client-id <id>   Override client id (default: rebootix-macos)
    ...
    do {
        ...
        let displayName = opts.displayName ?? Host.current().localizedName ?? "Rebootix macOS Debug CLI"
...
private func printConnectOutput(_ output: ConnectOutput, json: Bool) {
    ...
    print("Rebootix macOS Gateway Connect")
