...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/rebootix/rebootix") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/rebootix/rebootix")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://rebootix.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "RebootixBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "RebootixBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "RebootixGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "RebootixGitCommit") as? String) ??
            "unknown"
    }
