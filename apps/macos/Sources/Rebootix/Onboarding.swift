...
enum UIStrings {
    static let welcomeTitle = "Welcome to Rebootix"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: RebootixOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: RebootixChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g rebootix@\(version)"
    }
