...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.rebootix", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        RebootixPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        RebootixPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
