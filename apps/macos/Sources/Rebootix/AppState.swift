...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = RebootixConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = RebootixConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = RebootixConfigFile.loadDict()
            ...
            RebootixConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/rebootix"
        state.remoteCliPath = ""
        return state
    }
}
