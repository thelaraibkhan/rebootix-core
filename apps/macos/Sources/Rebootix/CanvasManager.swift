...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.rebootix", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Rebootix/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__rebootix__/a2ui/").absoluteString + "?platform=macos"
    }
