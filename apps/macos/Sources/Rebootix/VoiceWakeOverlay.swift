...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.rebootix", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Rebootix windows, but below the system’s pop-up menus.
