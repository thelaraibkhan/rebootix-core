...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.rebootix", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".rebootix/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.rebootixCommand(
            subcommand: "gateway",
