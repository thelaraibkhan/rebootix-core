...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.rebootix", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return RebootixConfigFile.defaultWorkspaceURL() }
