...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .rebootixSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? RebootixPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? RebootixPaths.stateDirURL.path
...
extension Notification.Name {
    static let rebootixSelectSettingsTab = Notification.Name("rebootixSelectSettingsTab")
}
