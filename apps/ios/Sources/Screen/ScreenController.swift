...
final class ScreenController {
    ...
    /// Callback invoked when an rebootix:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = RebootixKitResources.bundle
...
/// Handles navigation policy to intercept rebootix:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept rebootix:// deep links.
        if url.scheme?.lowercased() == "rebootix" {
