...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: RebootixLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: RebootixLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: RebootixLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
