...
@MainActor
public struct RebootixChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: RebootixChatViewModel,
    ...
    private var visibleMessages: [RebootixChatMessage] {
        let base: [RebootixChatMessage]
    ...
    private func mergeToolResults(in messages: [RebootixChatMessage]) -> [RebootixChatMessage] {
        ...
        for message in messages {
            ...
            let merged = RebootixChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: RebootixChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: RebootixChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: RebootixChatMessage) -> String {
