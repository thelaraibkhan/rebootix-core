...
public typealias RebootixPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias RebootixPlatformImage = UIImage
#endif

public struct RebootixChatUsageCost: Codable, Hashable, Sendable {
...
public struct RebootixChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: RebootixChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(RebootixChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct RebootixChatMessageContent: Codable, Hashable, Sendable {
...
public struct RebootixChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [RebootixChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: RebootixChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [RebootixChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: RebootixChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(RebootixChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([RebootixChatMessageContent].self, forKey: .content) {
...
public struct RebootixChatHistoryPayload: Codable, Sendable {
...
public struct RebootixSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct RebootixSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [RebootixSessionPreviewItem]
}

public struct RebootixSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [RebootixSessionPreviewEntry]

    public init(ts: Int, previews: [RebootixSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct RebootixChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct RebootixChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct RebootixAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct RebootixChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct RebootixGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct RebootixPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: RebootixPlatformImage?
...
public struct RebootixChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
