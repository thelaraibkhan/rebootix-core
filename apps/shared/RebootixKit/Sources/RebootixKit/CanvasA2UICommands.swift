...
public enum RebootixCanvasA2UICommand: String, Codable, Sendable {
...
public struct RebootixCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct RebootixCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
