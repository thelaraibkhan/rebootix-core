...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = RebootixChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = RebootixChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
