## Rebootix Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_rebootix-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm rebootix gateway --port 18789 --verbose
```
