# 🦞 Rebootix — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/rebootix/rebootix/main/docs/assets/rebootix-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/rebootix/rebootix/main/docs/assets/rebootix-logo-text.png" alt="Rebootix" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/rebootix/rebootix/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/rebootix/rebootix/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/rebootix/rebootix/releases"><img src="https://img.shields.io/github/v/release/rebootix/rebootix?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Rebootix** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://rebootix.ai) · [Docs](https://docs.rebootix.ai) · [DeepWiki](https://deepwiki.com/rebootix/rebootix) · [Getting Started](https://docs.rebootix.ai/start/getting-started) · [Updating](https://docs.rebootix.ai/install/updating) · [Showcase](https://docs.rebootix.ai/start/showcase) · [FAQ](https://docs.rebootix.ai/start/faq) · [Wizard](https://docs.rebootix.ai/start/wizard) · [Nix](https://github.com/rebootix/nix-rebootix) · [Docker](https://docs.rebootix.ai/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`rebootix onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.rebootix.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.rebootix.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.rebootix.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.rebootix.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.rebootix.ai/start/getting-started)

```bash
rebootix onboard --install-daemon

rebootix gateway --port 18789 --verbose

# Send a message
rebootix message send --to +1234567890 --message "Hello from Rebootix"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
rebootix agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.rebootix.ai/install/updating) (and run `rebootix doctor`).
...
Switch channels (git + npm): `rebootix update --channel stable|beta|dev`.
Details: [Development channels](https://docs.rebootix.ai/install/development-channels).
...
pnpm rebootix onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm rebootix ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `rebootix` binary.

## Security defaults (DM access)

Rebootix connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.rebootix.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `rebootix pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `rebootix doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.rebootix.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.rebootix.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.rebootix.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.rebootix.ai/nodes/voicewake) + [Talk Mode](https://docs.rebootix.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.rebootix.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.rebootix.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.rebootix.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.rebootix.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.rebootix.ai/nodes).
- **[Onboarding](https://docs.rebootix.ai/start/wizard) + [skills](https://docs.rebootix.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=rebootix/rebootix&type=date&legend=top-left)](https://www.star-history.com/#rebootix/rebootix&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.rebootix.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.rebootix.ai/web), and [Canvas host](https://docs.rebootix.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.rebootix.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.rebootix.ai/start/wizard), and [doctor](https://docs.rebootix.ai/gateway/doctor).
- [Pi agent runtime](https://docs.rebootix.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.rebootix.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.rebootix.ai/concepts/groups).
- [Media pipeline](https://docs.rebootix.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.rebootix.ai/nodes/audio).

### Channels

- [Channels](https://docs.rebootix.ai/channels): [WhatsApp](https://docs.rebootix.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.rebootix.ai/channels/telegram) (grammY), [Slack](https://docs.rebootix.ai/channels/slack) (Bolt), [Discord](https://docs.rebootix.ai/channels/discord) (discord.js), [Google Chat](https://docs.rebootix.ai/channels/googlechat) (Chat API), [Signal](https://docs.rebootix.ai/channels/signal) (signal-cli), [iMessage](https://docs.rebootix.ai/channels/imessage) (imsg), [BlueBubbles](https://docs.rebootix.ai/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.rebootix.ai/channels/msteams) (extension), [Matrix](https://docs.rebootix.ai/channels/matrix) (extension), [Zalo](https://docs.rebootix.ai/channels/zalo) (extension), [Zalo Personal](https://docs.rebootix.ai/channels/zalouser) (extension), [WebChat](https://docs.rebootix.ai/web/webchat).
- [Group routing](https://docs.rebootix.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.rebootix.ai/channels).

### Apps + nodes

- [macOS app](https://docs.rebootix.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.rebootix.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.rebootix.ai/nodes/talk) overlay, [WebChat](https://docs.rebootix.ai/web/webchat), debug tools, [remote gateway](https://docs.rebootix.ai/gateway/remote) control.
- [iOS node](https://docs.rebootix.ai/platforms/ios): [Canvas](https://docs.rebootix.ai/platforms/mac/canvas), [Voice Wake](https://docs.rebootix.ai/nodes/voicewake), [Talk Mode](https://docs.rebootix.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.rebootix.ai/platforms/android): [Canvas](https://docs.rebootix.ai/platforms/mac/canvas), [Talk Mode](https://docs.rebootix.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.rebootix.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.rebootix.ai/tools/browser): dedicated rebootix Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.rebootix.ai/platforms/mac/canvas): [A2UI](https://docs.rebootix.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.rebootix.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.rebootix.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.rebootix.ai/automation/cron-jobs); [webhooks](https://docs.rebootix.ai/automation/webhook); [Gmail Pub/Sub](https://docs.rebootix.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.rebootix.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.rebootix.ai/concepts/channel-routing), [retry policy](https://docs.rebootix.ai/concepts/retry), and [streaming/chunking](https://docs.rebootix.ai/concepts/streaming).
- [Presence](https://docs.rebootix.ai/concepts/presence), [typing indicators](https://docs.rebootix.ai/concepts/typing-indicators), and [usage tracking](https://docs.rebootix.ai/concepts/usage-tracking).
- [Models](https://docs.rebootix.ai/concepts/models), [model failover](https://docs.rebootix.ai/concepts/model-failover), and [session pruning](https://docs.rebootix.ai/concepts/session-pruning).
- [Security](https://docs.rebootix.ai/gateway/security) and [troubleshooting](https://docs.rebootix.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.rebootix.ai/web) + [WebChat](https://docs.rebootix.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.rebootix.ai/gateway/tailscale) or [SSH tunnels](https://docs.rebootix.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.rebootix.ai/install/nix) for declarative config; [Docker](https://docs.rebootix.ai/install/docker)-based installs.
- [Doctor](https://docs.rebootix.ai/gateway/doctor) migrations, [logging](https://docs.rebootix.ai/logging).
...
- **[Gateway WebSocket network](https://docs.rebootix.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.rebootix.ai/gateway)).
- **[Tailscale exposure](https://docs.rebootix.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.rebootix.ai/gateway/remote)).
- **[Browser control](https://docs.rebootix.ai/tools/browser)** — rebootix‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.rebootix.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.rebootix.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.rebootix.ai/nodes/voicewake) + [Talk Mode](https://docs.rebootix.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.rebootix.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

Rebootix can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Rebootix enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.rebootix.ai/gateway/tailscale) · [Web surfaces](https://docs.rebootix.ai/web)
...
Details: [Remote access](https://docs.rebootix.ai/gateway/remote) · [Nodes](https://docs.rebootix.ai/nodes) · [Security](https://docs.rebootix.ai/gateway/security)
...
Details: [Nodes](https://docs.rebootix.ai/nodes) · [macOS app](https://docs.rebootix.ai/platforms/macos) · [Gateway protocol](https://docs.rebootix.ai/concepts/architecture)
...
Details: [Session tools](https://docs.rebootix.ai/concepts/session-tool)

## Skills registry (RebootixHub)

RebootixHub is a minimal skill registry. With RebootixHub enabled, the agent can search for skills automatically and pull in new ones as needed.

[RebootixHub](https://rebootixhub.com)
...
- Controlled via `rebootix nodes …`.

Runbook: [iOS connect](https://docs.rebootix.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.rebootix.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.rebootix/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.rebootix/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.rebootix/rebootix.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.rebootix.ai/gateway/configuration)
...
Details: [Security guide](https://docs.rebootix.ai/gateway/security) · [Docker + sandboxing](https://docs.rebootix.ai/install/docker) · [Sandbox config](https://docs.rebootix.ai/gateway/configuration)

### [WhatsApp](https://docs.rebootix.ai/channels/whatsapp)

- Link the device: `pnpm rebootix channels login` (stores creds in `~/.rebootix/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.rebootix.ai/channels/telegram)
...
### [Slack](https://docs.rebootix.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.rebootix.ai/channels/discord)
...
### [Signal](https://docs.rebootix.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.rebootix.ai/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.rebootix.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.rebootix.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.rebootix.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.rebootix.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.rebootix.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.rebootix.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.rebootix.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.rebootix.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.rebootix.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.rebootix.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.rebootix.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.rebootix.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.rebootix.ai/platforms/windows), [Linux](https://docs.rebootix.ai/platforms/linux), [macOS](https://docs.rebootix.ai/platforms/macos), [iOS](https://docs.rebootix.ai/platforms/ios), [Android](https://docs.rebootix.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.rebootix.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.rebootix.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.rebootix.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.rebootix.ai/gateway/bonjour)
- [Gateway pairing](https://docs.rebootix.ai/gateway/pairing)
- [Remote gateway README](https://docs.rebootix.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.rebootix.ai/web/control-ui)
- [Dashboard](https://docs.rebootix.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.rebootix.ai/gateway/health)
- [Gateway lock](https://docs.rebootix.ai/gateway/gateway-lock)
- [Background process](https://docs.rebootix.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.rebootix.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.rebootix.ai/logging)

## Deep dives

- [Agent loop](https://docs.rebootix.ai/concepts/agent-loop)
- [Presence](https://docs.rebootix.ai/concepts/presence)
- [TypeBox schemas](https://docs.rebootix.ai/concepts/typebox)
- [RPC adapters](https://docs.rebootix.ai/reference/rpc)
- [Queue](https://docs.rebootix.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.rebootix.ai/tools/skills-config)
- [Default AGENTS](https://docs.rebootix.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.rebootix.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.rebootix.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.rebootix.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.rebootix.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.rebootix.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.rebootix.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.rebootix.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.rebootix.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.rebootix.ai/platforms/mac/voicewake)
- [iOS node](https://docs.rebootix.ai/platforms/ios)
- [Android node](https://docs.rebootix.ai/platforms/android)
- [Windows (WSL2)](https://docs.rebootix.ai/platforms/windows)
- [Linux app](https://docs.rebootix.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.rebootix.ai/gmail-pubsub](https://docs.rebootix.ai/automation/gmail-pubsub)

## Molty

Rebootix was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [rebootix.ai](https://rebootix.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@rebootix](https://x.com/rebootix)
