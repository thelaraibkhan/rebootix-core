...
- Version alignment with core Rebootix release numbers.
...
- First public release of the @rebootix/voice-call plugin.
...
- CLI: `rebootix voicecall` commands (call/start/continue/speak/end/status/tail/expose).
