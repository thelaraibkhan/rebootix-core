...
Nostr DM channel plugin for Rebootix using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Rebootix. It enables your bot to:
...
# Configure rebootix to use local relay
