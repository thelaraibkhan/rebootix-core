...
export function listZalouserAccountIds(cfg: RebootixConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: RebootixConfig): string {
...
function mergeZalouserAccountConfig(cfg: RebootixConfig, accountId: string): ZalouserAccountConfig {
