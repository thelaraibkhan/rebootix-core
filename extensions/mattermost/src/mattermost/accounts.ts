...
export function listMattermostAccountIds(cfg: RebootixConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: RebootixConfig): string {
...
export function listEnabledMattermostAccounts(cfg: RebootixConfig): ResolvedMattermostAccount[] {
