import type { ChannelOnboardingAdapter, RebootixConfig, WizardPrompter } from "rebootix/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.rebootix.ai/channels/mattermost",
    ].join("\n"),
