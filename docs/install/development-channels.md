...
Rebootix ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Rebootix also aligns
the install method:
...
When you switch channels with `rebootix update`, Rebootix also syncs plugin sources:
