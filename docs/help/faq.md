---
summary: "Frequently asked questions about Rebootix setup, configuration, and usage"
---
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up Rebootix?](#whats-the-recommended-way-to-install-and-set-up-rebootix)
  ...
  - [I can't access docs.rebootix.ai (SSL error). What now?](#i-cant-access-docsrebootixai-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or rebootix not recognized](#windows-install-says-git-not-found-or-rebootix-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Rebootix on Linux?](#how-do-i-install-rebootix-on-linux)
  - [How do I install Rebootix on a VPS?](#how-do-i-install-rebootix-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Rebootix to update itself?](#can-i-ask-rebootix-to-update-itself)
  ...
  - [If I buy a Mac mini to run Rebootix, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-rebootix-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Rebootix instances?](#can-multiple-people-use-one-whatsapp-number-with-different-rebootix-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Rebootix on a dedicated machine?](#how-important-is-it-to-run-rebootix-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Rebootix in a VM and what are the requirements](#can-i-run-rebootix-in-a-vm-and-what-are-the-requirements)
- [What is Rebootix?](#what-is-rebootix)
  - [What is Rebootix, in one paragraph?](#what-is-rebootix-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Rebootix](#what-are-the-top-five-everyday-use-cases-for-rebootix)
  - [Can Rebootix help with lead gen outreach ads and blogs for a SaaS](#can-rebootix-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Rebootix run tasks on a schedule or continuously in the background?](#can-rebootix-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Rebootix saved locally?](#is-all-data-used-with-rebootix-saved-locally)
  - [Where does Rebootix store its data?](#where-does-rebootix-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Rebootix?](#how-do-i-completely-uninstall-rebootix)
...
- [Config basics](#config-basics)
  ...
  - [Can the Rebootix browser run headless?](#can-the-rebootix-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two Rebootix instances talk to each other (local + VPS)?](#can-two-rebootix-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Rebootix load environment variables?](#how-does-rebootix-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of Rebootix instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-rebootix-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Rebootix but keep it installed?](#how-do-i-completely-reset-rebootix-but-keep-it-installed)
  ...
  - [Why doesn’t Rebootix reply in a group?](#why-doesnt-rebootix-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Rebootix, Flawd, and Krill use for models?](#what-do-rebootix-flawd-and-krill-use-for-models)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `rebootix gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-rebootix-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `rebootix gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-rebootix-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Rebootix in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-rebootix-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Rebootix?](#i-closed-my-terminal-on-windows-how-do-i-restart-rebootix)
  ...
  - [ELI5: `rebootix gateway restart` vs `rebootix gateway`](#eli5-rebootix-gateway-restart-vs-rebootix-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Rebootix to inbound DMs?](#is-it-safe-to-expose-rebootix-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/rebootix/rebootix-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   rebootix health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://rebootix.bot/install.sh | bash -s -- --install-method git
```

This installs Rebootix **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/rebootix/rebootix/issues
https://github.com/rebootix/rebootix/pulls

Start with these commands (share outputs when asking for help):

```bash
rebootix status
rebootix models status
rebootix doctor
```

What they do:

- `rebootix status`: quick snapshot of gateway/agent health + basic config.
- `rebootix models status`: checks provider auth + model availability.
- `rebootix doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `rebootix status --all`, `rebootix logs --follow`,
`rebootix gateway status`, `rebootix health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Rebootix

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://rebootix.bot/install.sh | bash
rebootix onboard --install-daemon
```
...
```bash
git clone https://github.com/rebootix/rebootix.git
cd rebootix
pnpm install
pnpm build
...
If you don’t have a global install yet, run it via `pnpm rebootix onboard`.
...
- If it asks for auth, run `rebootix dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `REBOOTIX_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `rebootix gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `rebootix gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `rebootix dashboard`.
...
1. Install Rebootix on the new machine.
2. Copy `$REBOOTIX_STATE_DIR` (default: `~/.rebootix`) from the old machine.
3. Copy your workspace (default: `~/.rebootix/workspace`).
4. Run `rebootix doctor` and restart the Gateway service.
...
under `~/.rebootix/` (for example `~/.rebootix/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-rebootix-store-its-data),
...
https://github.com/rebootix/rebootix/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.rebootix.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.rebootix.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.rebootix.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsrebootixai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/rebootix/rebootix/tree/main/docs
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://rebootix.bot/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://rebootix.bot/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
https://rebootix.ai/install.ps1
...
```bash
curl -fsSL https://rebootix.bot/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://rebootix.bot/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://rebootix.bot/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or rebootix not recognized
...
**2) rebootix is not recognized after install**
...
### How do I install Rebootix on Linux
...
### How do I install Rebootix on a VPS
...
### Can I ask Rebootix to update itself
...
```bash
rebootix update
rebootix update status
rebootix update --channel stable|beta|dev
rebootix update --tag <dist-tag|version>
rebootix update --no-restart
```

If you must automate from an agent:

```bash
rebootix update --yes --no-restart
rebootix gateway restart
```
...
`rebootix onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Rebootix with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `rebootix models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `rebootix models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `rebootix models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. Rebootix no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Rebootix can keep replying while a provider is rate‑limited.
...
Rebootix supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Rebootix fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `rebootix.json`.

Steps:

1. Enable the plugin: `rebootix plugins enable google-gemini-cli-auth`
2. Login: `rebootix models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Rebootix needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Rebootix runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. Rebootix’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run Rebootix can I connect it to my MacBook Pro
...
- Use `rebootix nodes status` / `rebootix nodes list` to see it.
...
- DM your bot, then run `rebootix logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Rebootix instances
...
If you run Rebootix via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the Rebootix code install. Your state
(`~/.rebootix`) and workspace (`~/.rebootix/workspace`) stay untouched.
...
**Rebootix-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Rebootix on a dedicated machine
...
Rebootix is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Rebootix in a VM and what are the requirements
...
### What is Rebootix in one paragraph

Rebootix is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

Rebootix is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Rebootix
...
### Can Rebootix help with lead gen outreach ads and blogs for a SaaS
...
Rebootix draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Rebootix is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Rebootix when you
...
Showcase: https://rebootix.ai/showcase

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.rebootix/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.rebootix/rebootix.json`). Precedence is `<workspace>/skills` > `~/.rebootix/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.
...
- Confirm cron is enabled (`cron.enabled`) and `REBOOTIX_SKIP_CRON` is not set.
...
```bash
rebootix cron run <jobId> --force
rebootix cron runs --id <jobId> --limit 50
```
...
Not directly. macOS skills are gated by `metadata.rebootix.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-rebootix-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Rebootix can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.rebootix/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: { "rebootix": { "os": ["darwin", "linux"], "requires": { "bins": ["imsg"] } } }
   ---
   ```
4. Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (Rebootix only needs stdio). See [iMessage](/channels/imessage).
...
Rebootix memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Rebootix also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, Rebootix auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Rebootix
prefers `local`.
...
### Is all data used with Rebootix saved locally

No - **Rebootix’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.rebootix` + your workspace directory).
...
### Where does Rebootix store its data

Everything lives under `$REBOOTIX_STATE_DIR` (default: `~/.rebootix`):

| Path                                                            | Purpose                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------ |
| `$REBOOTIX_STATE_DIR/rebootix.json`                             | Main config (JSON5)                                          |
| `$REBOOTIX_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$REBOOTIX_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$REBOOTIX_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$REBOOTIX_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$REBOOTIX_STATE_DIR/agents/`                                   | Per‑agent state (agentDir + sessions)                        |
| `$REBOOTIX_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$REBOOTIX_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single‑agent path: `~/.rebootix/agent/*` (migrated by `rebootix doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.rebootix/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.rebootix`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.rebootix`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.rebootix/skills`).

Default workspace is `~/.rebootix/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.rebootix/workspace" } },
}
```
...
Do **not** commit anything under `~/.rebootix` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Rebootix
...
`workspace` to the repo root. The Rebootix repo is just source code; keep the
...
Rebootix reads an optional **JSON5** config from `$REBOOTIX_CONFIG_PATH` (default: `~/.rebootix/rebootix.json`):

```
$REBOOTIX_CONFIG_PATH
```

If the file is missing, it uses safe‑ish defaults (including a default workspace of `~/.rebootix/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `REBOOTIX_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `rebootix doctor --generate-gateway-token`.
...
key. **Recommended:** run `rebootix configure --section web` to store it in
...
- Daemons read env vars from `~/.rebootix/.env` (or the service environment).
...
### Can the Rebootix browser run headless
...
5. Approve the node on the Gateway:
   ```bash
   rebootix nodes pending
   rebootix nodes approve <requestId>
   ```
...
- Gateway is running: `rebootix gateway status`
- Gateway health: `rebootix status`
- Channel health: `rebootix channels status`
...
### Can two Rebootix instances talk to each other local VPS
...
`rebootix agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
rebootix agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.rebootix/rebootix.json`).
- If you have no backup, re-run `rebootix doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `rebootix config set` for small changes.
- Use `rebootix configure` for interactive edits.
...
```bash
rebootix gateway --tailscale serve
```
...
### How does Rebootix load environment variables

Rebootix reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.rebootix/.env` (aka `$REBOOTIX_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.rebootix/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`REBOOTIX_LOAD_SHELL_ENV=1`, `REBOOTIX_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`rebootix models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means Rebootix won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.rebootix/.env`:
   ```
...
### Is there a way to make a team of Rebootix instances one CEO and many agents
...
### How do I completely reset Rebootix but keep it installed
...
```bash
rebootix reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `REBOOTIX_PROFILE`), reset each state dir (defaults are `~/.rebootix-<profile>`).
- Dev reset: `rebootix gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Rebootix skips the heartbeat run to save API calls.
...
No. Rebootix runs on **your own account**, so if you’re in the group, Rebootix can see it.
...
```bash
rebootix directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Rebootix reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.rebootix/agents/<agentId>/sessions/`.
...
- Use `rebootix doctor` to spot stray workspaces and profile mismatches.
...
Rebootix’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, Rebootix currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `rebootix models set ...` (updates just model config)
- `rebootix configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.rebootix/rebootix.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `rebootix doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do Rebootix, Flawd, and Krill use for models

- **Rebootix + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-5`) - see [Anthropic](/providers/anthropic).
...
Yes. Rebootix ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.rebootix/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `rebootix agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Rebootix can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.rebootix/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.rebootix/agent/*` (migrated by `rebootix doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.rebootix/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `rebootix models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `rebootix models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `rebootix models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.rebootix/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    rebootix models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Rebootix will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: Rebootix now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Rebootix uses provider‑prefixed IDs like:
...
Rebootix may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `rebootix models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
rebootix models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
rebootix models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
rebootix models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
rebootix models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

Rebootix supports both:
...
```
--port > REBOOTIX_GATEWAY_PORT > gateway.port > default 18789
```

### Why does rebootix gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `rebootix gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does rebootix gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `REBOOTIX_STATE_DIR` mismatch).

Fix:

```bash
rebootix gateway install --force
```
...
Rebootix enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `rebootix gateway --port <port>`.

### How do I run Rebootix in remote mode client connects to a Gateway elsewhere
...
- `rebootix gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `rebootix.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:

- Fastest: `rebootix dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `rebootix doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `REBOOTIX_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `rebootix status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `REBOOTIX_CONFIG_PATH` (per‑instance config)
- `REBOOTIX_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `rebootix --profile <name> …` per instance (auto-creates `~/.rebootix-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `rebootix --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.rebootix.*`, `rebootix-gateway-<profile>.service`, `Rebootix Gateway (<profile>)`).
...
```
rebootix tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/rebootix/rebootix-YYYY-MM-DD.log
```
...
- macOS: `$REBOOTIX_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.rebootix/logs/...`; profiles use `~/.rebootix-<profile>/logs/...`)
- Linux: `journalctl --user -u rebootix-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Rebootix Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `rebootix gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Rebootix
...
1. Is the Gateway running? `rebootix gateway status`
2. Is the Gateway healthy? `rebootix status`
3. Does the UI have the right token? `rebootix dashboard`
...
```bash
rebootix channels status
rebootix channels logs --channel telegram
```
...
### ELI5 rebootix gateway restart vs rebootix gateway

- `rebootix gateway restart`: restarts the **background service** (launchd/systemd).
- `rebootix gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `rebootix gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Rebootix assistant setup](/start/rebootix) and [Agent send](/tools/agent-send).

CLI sending:

```bash
rebootix message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Rebootix to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `rebootix pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `rebootix pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `rebootix doctor` to surface risky DM policies.
...
```bash
rebootix pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Rebootix only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
rebootix pairing approve whatsapp <code>
```

List pending requests:

```bash
rebootix pairing list whatsapp
```
...
Rebootix blocks **cross‑provider** messaging by default. If a tool call is bound
...
**A:** In Rebootix, credentials and model selection are separate. Setting `ANTHROPIC_API_KEY` (or storing an Anthropic API key in auth profiles) enables authentication, but the actual default model is whatever you configure in `agents.defaults.model.primary` (for example, `anthropic/claude-sonnet-4-5` or `anthropic/claude-opus-4-5`). If you see `No credentials found for profile "anthropic:default"`, it means the Gateway couldn’t find Anthropic credentials in the expected `auth-profiles.json` for the agent that’s running.

---

Still stuck? Ask in [Discord](https://discord.com/invite/clawd) or open a [GitHub discussion](https://github.com/rebootix/rebootix/discussions).
