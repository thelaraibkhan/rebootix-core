...
You can point Rebootix at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Rebootix
...
- [Anthropic provider](/providers/anthropic) - Native Rebootix integration with Claude setup-token or API keys
