---
summary: "Use Qwen OAuth (free tier) in Rebootix"
read_when:
  - You want to use Qwen with Rebootix
...
```bash
rebootix models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Rebootix will sync credentials
