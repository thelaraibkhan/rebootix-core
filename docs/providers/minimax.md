---
summary: "Use MiniMax M2.1 in Rebootix"
read_when:
  - You want MiniMax models in Rebootix
...
Configure manually via `rebootix.json`:
...
- Use `rebootix models list` and `rebootix models set minimax/MiniMax-M2.1` to switch.
...
- Running `rebootix configure` and selecting **MiniMax M2.1**, or
