---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Rebootix"
read_when:
  - You want Xiaomi MiMo models in Rebootix
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Rebootix uses
...
```bash
rebootix onboard --auth-choice xiaomi-api-key
# or non-interactive
rebootix onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
