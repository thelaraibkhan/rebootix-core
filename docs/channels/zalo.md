...
- Install via CLI: `rebootix plugins install @rebootix/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `rebootix plugins install ./extensions/zalo`
   - From npm (if published): `rebootix plugins install @rebootix/zalo`
...
- Approve via:
  - `rebootix pairing list zalo`
  - `rebootix pairing approve zalo <CODE>`
...
- Example: `rebootix message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `rebootix channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `rebootix logs --follow`
