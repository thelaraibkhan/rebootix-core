---
summary: "RebootixHub guide: public skills registry + CLI workflows"
read_when:
  - Introducing RebootixHub to new users
  - Installing, searching, or publishing skills
  - Explaining RebootixHub CLI flags and sync behavior
---
...
If you want to add new capabilities to your Rebootix agent, RebootixHub is the easiest way to find and install skills. You do not need to know how the backend works. You can:
...
- `--workdir <dir>`: Working directory (default: current dir; falls back to Rebootix workspace).
