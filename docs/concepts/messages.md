...
This page ties together how Rebootix handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Rebootix keeps a
...
Rebootix separates the **prompt body** from the **command body**:
...
Rebootix can expose or hide model reasoning:
