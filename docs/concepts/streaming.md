...
Rebootix has two separate “streaming” layers:
...
When block streaming is enabled, Rebootix can **merge consecutive block chunks**
...
When draft streaming is active, Rebootix disables block streaming for that reply to avoid double-streaming.
