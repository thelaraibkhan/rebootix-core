...
Rebootix treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.rebootix/settings/voicewake.json`

Shape:

```json
{ "triggers": ["rebootix", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
