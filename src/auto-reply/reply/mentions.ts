...
function resolveMentionPatterns(cfg: RebootixConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: RebootixConfig | undefined, agentId?: string): RegExp[] {
