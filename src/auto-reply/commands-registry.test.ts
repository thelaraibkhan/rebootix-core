...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@rebootix", { botUsername: "rebootix" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@rebootix args", {
        botUsername: "rebootix",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@rebootix: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "rebootix" })).toBe(
      "/help@otherbot",
    );
  });
