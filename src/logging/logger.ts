...
export const DEFAULT_LOG_DIR = "/tmp/rebootix";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "rebootix.log"); // legacy single-file path

const LOG_PREFIX = "rebootix";
...
function resolveSettings(): ResolvedSettings {
  let cfg: RebootixConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => RebootixConfig;
      };
