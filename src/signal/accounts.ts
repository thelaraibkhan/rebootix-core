...
export function listSignalAccountIds(cfg: RebootixConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: RebootixConfig): string {
...
function mergeSignalAccountConfig(cfg: RebootixConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: RebootixConfig): ResolvedSignalAccount[] {
