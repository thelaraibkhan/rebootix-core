...
import { discoverRebootixPlugins } from "../../plugins/discovery.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { RebootixPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, RebootixPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["REBOOTIX_PLUGIN_CATALOG_PATHS", "REBOOTIX_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<RebootixPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: RebootixPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: RebootixPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverRebootixPlugins({ workspaceDir: options.workspaceDir });
