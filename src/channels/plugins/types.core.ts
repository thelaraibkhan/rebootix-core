...
export type ChannelAgentToolFactory = (params: { cfg?: RebootixConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: RebootixConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: RebootixConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: RebootixConfig }) => boolean;
  supportsCards?: (params: { cfg: RebootixConfig }) => boolean;
