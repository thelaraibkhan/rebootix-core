...
import { type RebootixConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: RebootixConfig): string[] {
...
export function listAgentsForGateway(cfg: RebootixConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: RebootixConfig): string {
...
function resolveSessionStoreAgentId(cfg: RebootixConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: RebootixConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: RebootixConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: RebootixConfig): GatewaySessionsDefaults {
