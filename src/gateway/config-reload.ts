...
import type { RebootixConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: RebootixConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: RebootixConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: RebootixConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: RebootixConfig) => void;
  log: {
