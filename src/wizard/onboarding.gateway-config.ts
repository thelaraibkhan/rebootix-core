...
import type { GatewayBindMode, GatewayTailscaleMode, RebootixConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.rebootix.ai/gateway/tailscale", "https://docs.rebootix.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
