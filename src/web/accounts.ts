...
function listConfiguredAccountIds(cfg: RebootixConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: RebootixConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: RebootixConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: RebootixConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: RebootixConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: RebootixConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: RebootixConfig): ResolvedWhatsAppAccount[] {
