...
export const A2UI_PATH = "/__rebootix__/a2ui";

export const CANVAS_HOST_PATH = "/__rebootix__/canvas";

export const CANVAS_WS_PATH = "/__rebootix__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.rebootixCanvasA2UIAction.postMessage(...)
  // - Android: window.rebootixCanvasA2UIAction.postMessage(...)
  const handlerNames = ["rebootixCanvasA2UIAction"];
  ...
  globalThis.Rebootix = globalThis.Rebootix ?? {};
  globalThis.Rebootix.postMessage = postToNode;
  globalThis.Rebootix.sendUserAction = sendUserAction;
  globalThis.rebootixPostMessage = postToNode;
  globalThis.rebootixSendUserAction = sendUserAction;
