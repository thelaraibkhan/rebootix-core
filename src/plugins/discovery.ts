...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @rebootix/voice-call -> voice-call).
...
export function discoverRebootixPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".rebootix", "extensions")];
