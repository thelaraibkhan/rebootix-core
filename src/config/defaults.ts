...
function resolveAnthropicDefaultAuthMode(cfg: RebootixConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: RebootixConfig): RebootixConfig {
...
export function applyTalkApiKey(config: RebootixConfig): RebootixConfig {
...
export function applyModelDefaults(cfg: RebootixConfig): RebootixConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: RebootixConfig): RebootixConfig {
...
export function applyLoggingDefaults(cfg: RebootixConfig): RebootixConfig {
...
export function applyContextPruningDefaults(cfg: RebootixConfig): RebootixConfig {
...
export function applyCompactionDefaults(cfg: RebootixConfig): RebootixConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
