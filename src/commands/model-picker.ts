...
function resolveConfiguredModelRaw(cfg: RebootixConfig): string {
...
function resolveConfiguredModelKeys(cfg: RebootixConfig): string[] {
...
export function applyPrimaryModel(cfg: RebootixConfig, model: string): RebootixConfig {
...
export function applyModelAllowlist(cfg: RebootixConfig, models: string[]): RebootixConfig {
  const defaults = cfg.agents?.defaults;
