...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.rebootix.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("rebootix hooks list")}`,
      `  ${formatCliCommand("rebootix hooks enable <name>")}`,
      `  ${formatCliCommand("rebootix hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
