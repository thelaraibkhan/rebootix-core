...
export function applyZaiConfig(cfg: RebootixConfig): RebootixConfig {
...
export function applyOpenrouterProviderConfig(cfg: RebootixConfig): RebootixConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: RebootixConfig): RebootixConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: RebootixConfig): RebootixConfig {
...
export function applyOpenrouterConfig(cfg: RebootixConfig): RebootixConfig {
...
export function applyMoonshotProviderConfig(cfg: RebootixConfig): RebootixConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: RebootixConfig): RebootixConfig {
...
export function applyKimiCodeProviderConfig(cfg: RebootixConfig): RebootixConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: RebootixConfig): RebootixConfig {
...
export function applySyntheticProviderConfig(cfg: RebootixConfig): RebootixConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: RebootixConfig): RebootixConfig {
...
export function applyXiaomiProviderConfig(cfg: RebootixConfig): RebootixConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: RebootixConfig): RebootixConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: RebootixConfig): RebootixConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: RebootixConfig): RebootixConfig {
