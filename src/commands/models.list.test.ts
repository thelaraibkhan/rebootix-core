...
const ensureRebootixModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveRebootixAgentDir = vi.fn().mockReturnValue("/tmp/rebootix-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/rebootix-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureRebootixModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveRebootixAgentDir,
}));
