...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "rebootix-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<RebootixConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<RebootixConfig["telegram"]>>,
