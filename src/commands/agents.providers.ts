...
function resolveDefaultAccountId(cfg: RebootixConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: RebootixConfig): boolean {
...
export function summarizeBindings(cfg: RebootixConfig, bindings: AgentBinding[]): string[] {
