...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof RebootixConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: RebootixConfig; env: NodeJS.ProcessEnv }): {
  cfg: RebootixConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
