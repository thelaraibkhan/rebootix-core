...
function resolveAvatarSource(cfg: RebootixConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: RebootixConfig, agentId: string): AgentAvatarResolution {
