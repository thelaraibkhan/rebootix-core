...
function resolveExecConfig(cfg: RebootixConfig | undefined) {
...
export function createRebootixCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createRebootixReadTool(freshReadTool)];
    }
