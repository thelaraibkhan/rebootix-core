...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".rebootix", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "rebootix-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "rebootix-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "rebootix-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "rebootix-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "rebootix-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".rebootix");
