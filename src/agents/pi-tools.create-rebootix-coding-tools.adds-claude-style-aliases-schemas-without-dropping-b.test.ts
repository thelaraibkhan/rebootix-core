...
describe("createRebootixCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createRebootixCodingTools({
      config,
    ...
    const anthropicTools = createRebootixCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createRebootixCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createRebootixCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
