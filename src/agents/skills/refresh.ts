...
function resolveWatchPaths(workspaceDir: string, config?: RebootixConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: RebootixConfig }) {
