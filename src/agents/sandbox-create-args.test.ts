  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "rebootix.sandbox=1",
        "--label",
        "rebootix.sessionKey=main",
        "--label",
        "rebootix.createdAtMs=1700000000000",
        "--label",
        "rebootix.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
