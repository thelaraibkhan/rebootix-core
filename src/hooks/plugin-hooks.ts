...
import type { RebootixPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: RebootixPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: RebootixPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
