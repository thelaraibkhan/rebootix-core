...
const SANDBOX_EXAMPLES = {
  main: [
    ["rebootix sandbox list", "List all sandbox containers."],
    ["rebootix sandbox list --browser", "List only browser containers."],
    ["rebootix sandbox recreate --all", "Recreate all containers."],
    ["rebootix sandbox recreate --session main", "Recreate a specific session."],
    ["rebootix sandbox recreate --agent mybot", "Recreate agent containers."],
    ["rebootix sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["rebootix sandbox list", "List all sandbox containers."],
    ["rebootix sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["rebootix sandbox recreate --all", "Recreate all containers."],
    ["rebootix sandbox recreate --session main", "Recreate a specific session."],
    ["rebootix sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["rebootix sandbox recreate --browser --all", "Recreate only browser containers."],
    ["rebootix sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["rebootix sandbox explain", "Show effective sandbox config."],
    ["rebootix sandbox explain --session agent:main:main", "Explain a specific session."],
    ["rebootix sandbox explain --agent work", "Explain an agent sandbox."],
    ["rebootix sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.rebootix.ai/cli/sandbox")}\n`,
    )
    .action(() => {
