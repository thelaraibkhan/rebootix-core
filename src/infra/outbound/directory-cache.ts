...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: RebootixConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: RebootixConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: RebootixConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: RebootixConfig): void {
