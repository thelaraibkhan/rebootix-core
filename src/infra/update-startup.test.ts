...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "rebootix-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveRebootixPackageRoot } = await import("./rebootix-root.js");
    ...
    vi.mocked(resolveRebootixPackageRoot).mockResolvedValue("/opt/rebootix");
